...
import InquireDetailPage from "../views/MyPage/InquireDetailPage";
import InquireEditPage from "../views/MyPage/InquireEditPage";
...
import AMemberDetailPage from "../views/Admin/AMemberDetailPage";


import ACsPage from "../views/Admin/ACsPage";
...
const routes = [
  ...
  {
    path: "/mypage/inquire/detail",
    name: "inquiredetail",
    component: InquireDetailPage,
  },
  {
    path: "/mypage/inquire/edit",
    name: "inquireedit",
    component: InquireEditPage,
  },
  ...
  {
    path: "/admin/cs/detail",
    name: "admincsdetail",
    component: ACsDetailPage,
  },
  {
    path: "/admin/cs/edit",
    name: "admincsedit",
    component: ACsEditPage,
  },
  {
    path: "/admin/cs/register",
    name: "admincsregister",
    component: ACsRegisterPage,
  },
